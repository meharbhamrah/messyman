  ...
  return (
    <header className="relative z-20 w-full paper-card rounded-2xl px-4 sm:px-6 py-3 mb-8 shadow-soft backdrop-blur-md flex items-center justify-between transition-all duration-300 hover:shadow-hover">
      <div className="flex items-center gap-3">
        <div className="p-1.5 rounded-xl bg-primary-gradient text-white shadow-md">
          <BookOpen className="h-5 w-5" />
        </div>
        <span className="font-semibold text-lg tracking-tight text-foreground">Messyman</span>
        <span className="hidden sm:inline-flex items-center gap-1 ml-1 text-xs text-primary bg-primary/10 px-2 py-0.5 rounded-full">
          Journey
        </span>
      </div>
      ...
      <div className="hidden md:flex items-center gap-2">
        {navItems.map((item) => (
          <Button
            ...
            className="text-muted-foreground hover:text-foreground hover:bg-secondary/60 gap-1.5"
          >
        ...
        <Button
          ...
          className="text-muted-foreground hover:text-rose-600 hover:bg-rose-50/60 gap-1.5"
        >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="md:hidden text-foreground hover:bg-secondary/60"
        ...
        <div className="absolute top-full left-4 right-4 mt-2 md:hidden paper-card rounded-xl shadow-lg p-4 flex flex-col gap-2 z-50">
          {navItems.map((item) => (
            <Button
              key={item.label}
              variant="ghost"
              className="justify-start text-foreground/70 hover:text-foreground hover:bg-secondary/60"
              onClick={() => {
          ...
          <Button
            variant="ghost"
            className="justify-start text-rose-600 hover:bg-rose-50/60"
            onClick={handleSignOut}
          >
